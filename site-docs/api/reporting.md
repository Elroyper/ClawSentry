...
`decision`, `session_start`, `session_risk_change`, `alert`, `session_enforcement_change`, `defer_pending`, `defer_resolved`, `post_action_finding`, `trajectory_alert`, `pattern_candidate`, `pattern_evolved`, `l3_advisory_snapshot`, `l3_advisory_review`, `l3_advisory_job`
