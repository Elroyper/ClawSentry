...
| Heartbeat / idle aggregate queueing | `decision-layers/l3-advisory.md` Phase 3 sections; validation docs under `docs/validation/l3-advisory-phase3-*` | [L3 咨询审查](../decision-layers/l3-advisory.md) | CLI jobs list/run-next/drain、watch/SSE | Covered | 确认在矩阵中显式列出，避免只在正文深处出现。 |
