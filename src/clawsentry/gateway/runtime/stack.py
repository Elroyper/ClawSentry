...
Usage:
  python -m clawsentry.gateway.stack
"""
...
from clawsentry.gateway.core.approval_bridge import _validate_rewrite_resolution_payload
from clawsentry.gateway.core.supervision_gateway import SupervisionGateway
from clawsentry.gateway.http.app import _make_auth_dependency, _read_auth_token, create_http_app
...
from clawsentry.gateway.transport.runner import (
    DEFAULT_HTTP_HOST,
    DEFAULT_HTTP_PORT,
)
from clawsentry.gateway.transport.uds import (
    start_uds_server,
)
...
async def run_stack(args: argparse.Namespace) -> None:
    ...
    if codex_session_dir is not None:
        from clawsentry.gateway.runtime.codex_watcher import CodexSessionWatcher
