...
from clawsentry.gateway.config.llm_settings import resolve_llm_settings, resolve_provider_retry_config_kwargs
...
def build_l3_advisory_provider(config: LLMAdvisoryProviderConfig) -> LLMAdvisoryProvider:
    ...
    if not normalized.dry_run and provider in {"openai", "anthropic"}:
        ...
        provider_config = LLMProviderConfig(
            ...
            **resolve_provider_retry_config_kwargs(environ=os.environ),
        )
